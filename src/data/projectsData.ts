...
export const projectsData: Project[] = [
    {
        ...
        descriptionLong: ["Managing expenses in a shared boarding environment can be challenging...",],
    ...
    },
    {
        ...
        descriptionLong: ["The Web-based System for Kelani STEAM is a comprehensive platform designed to streamline...",],
    ...
    },
    {
        ...
        descriptionLong: ["The E-Channelling and Order Medicine System was developed as my final individual project at university...", ],
    ...
    },
    {
        ...
        descriptionLong: ["The Hospital Management System was developed as a mock group project to simulate the operations of a small-scale hospital...", ],
        techStack: ["React JS", "Spring boot", "MongoDB", "Material UI", "Tailwind CSS"],
        githubLinkFrontend: "https://github.com/pramodyasamarakoon/Aromed_Frontend.git",
        githubLinkBackend:"https://github.com/pramodyasamarakoon/Aromed-Backend.git",
    },
